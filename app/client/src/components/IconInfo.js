    ...
    render() {
        ...
        return (
            <span className={`${hover ? "cursor-pointer" : ""} jam jam-${icon} noBorder`}
                ...
                data-content={htmlChildren} style={{ color: colorIcon, fontSize: 16 }} onMouseEnter={this.handleHover.bind(this, hover)} onMouseLeave={this.handleHover.bind(this, color)}></span>
        );
    }
}