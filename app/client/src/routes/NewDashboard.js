                    ...
                    <div className="d-card-columns">
                        ...
                        <div className="card" style={{ backgroundColor: "#3a5574" }}>
                            ...
                            <div className="card-body">
                                ...
                                <div>
                                    <a href="" className="btn btn-lg btn-block grad" target="_blank" style={{ fontSize: "20px", color: "#fff", padding: "2rem", marginBottom: "1rem", textAlign: "left" }}>
                        ...
                        <div className="card" style={{ backgroundColor: "#3a5574" }}>
                            ...
                            <div className="card-body">
                                ...
                                <div>
                                    <a href="#" className="btn btn-lg btn-block grad" style={{ fontSize: "20px", color: "#fff", padding: "2rem", marginBottom: "1rem", textAlign: "left" }}>
